<?php
class Modcfdi_traslados extends MY_Model {
	protected $base_table			= "cfdi_traslados";
	protected $general_view			= "cfdi_traslados";
	protected $particular_view		= "cfdi_traslados";
	protected $definition_file		= 'cfdi_traslados.json';
	...
	public function set_field( $field, $value ) {
		...
		$this->fields[ $field ] = parent::get_field( 'idcfdi_comprobante' ) . "___" . parent::get_field( 'impuesto' ) . "___" . parent::get_field( 'tipofactor' );
		return true;
	}
	public function get_field( $field ) {
		if( 'primary_key' == $field ) {
			return parent::get_field( 'idcfdi_comprobante' ) . "___" . parent::get_field( 'impuesto' ) . "___" . parent::get_field( 'tipofactor' );
		}
	...
	public function get_from_database( $pk_value = "" ) {
		...
		$this->db->where( " concat( idcfdi_comprobante, '___' , impuesto, '___' , tipofactor ) = '$pk' " );
	...
	public function get_all( $where = "" ) {
		...
		if( 0 < $regs->num_rows() ) {
			...
			foreach( $res as $k => $reg ) {
				$res[ $k ][ "primary_key" ] = $reg[ "idcfdi_comprobante"] . "___" . $reg[ "impuesto" ] . "___" . $reg[ "tipofactor" ];
			}
		}
		return $res;
	}
