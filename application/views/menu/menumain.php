	...
	<div class="container">
		...
		<div class="btn-group pull-right menu_principal">
			<?php if(!$justCloseWindow)
			{
				...
				<div class="btn-group" >
					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" title="Documentación">
						Documentacion <span class="caret"></span>
					</button>
					<ul class="dropdown-menu">
						<?php if($this->modsesion->hasPermisoHijo(122)): ?>
						<li><a href="http://pisa.servicios-simma.com.mx" target="_blank">PISA</a></li>
						<?php endif;
						if($this->modsesion->hasPermisoHijo(123)): ?>
						<li><a href="http://pisa.servicios-simma.com.mx/1._DIMESA" target="_blank">PISA - DIMESA</a></li>
						<?php endif;
						if($this->modsesion->hasPermisoHijo(124)): ?>
						<li><a href="http://pisa.servicios-simma.com.mx/2._F._LA_PAZ" target="_blank">PISA - FARMACIA LA PAZ</a></li>
						<?php endif;
						if($this->modsesion->hasPermisoHijo(125)): ?>
						<li><a href="http://pisa.servicios-simma.com.mx/3._MEDICOM" target="_blank">PISA - MEDICOM</a></li>
						<?php endif;
						if($this->modsesion->hasPermisoHijo(126)): ?>
						<li><a href="http://pisa.servicios-simma.com.mx/4._SAFE" target="_blank">PISA - SAFE</a></li>
						<?php endif;
						if($this->modsesion->hasPermisoHijo(127)): ?>
						<li><a href="http://pisa.servicios-simma.com.mx/5._SANEFRO" target="_blank">PISA - SANEFRO</a></li>
						<?php endif; ?>
					</ul>
				</div>
				<?php endif;
				if($this->modsesion->hasPermisoHijo(1)): ?>
				<div class="btn-group">
