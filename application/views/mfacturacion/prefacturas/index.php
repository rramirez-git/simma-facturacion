<!-- mprefacturacion/prefacturas/index starts<?php if( $this->config->item( 'log_threshold' ) ) : ?>, called by
...
<div class="float-right">
	<div class="btn-toolbar" role="toolbar" aria-label="Acciones">
		<div class="btn-group mr-2" role="group" aria-label="Acciones por Elemento">
			<a title="Nueva Pre-Factura Libre" href="<?php echo base_url( $controler . '/nueva_libre' ); ?>" class="btn btn-outline-primary">
...
<!-- mprefacturacion/prefacturas/index ends -->