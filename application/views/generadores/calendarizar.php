...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-10">(<?= $cliente->getIdentificador(); ?>) <?= $cliente->getRazonsocial() . ( $cliente->getNombreCorto() != "" ? " - " . $cliente->getNombreCorto() : "" ); ?></div>
	</div>
	<div class="row">
		<div class="col-xs-2">Generador:</div>
		<div class="col-xs-10">(<?= $objeto->getIdentificador(); ?>) <?= $objeto->getRazonsocial() . ( $objeto->getNombreCorto() != "" ? " - " . $objeto->getNombreCorto() : "" ); ?></div>
	</div>
	<div class="row">
